...
Note: Documentation of the structure of my submission directory (for programs and technical achievement) is in the appendix in chapter~\ref{appendix}, and description of where to find each report and program can be found in the summary of completed work in chapter~\ref{chapter:summary}.
\section{The Problem}

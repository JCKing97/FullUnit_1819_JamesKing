...
:- begin_tests(standing_tests).
	...
	test(spread_accurate_positive_trusting_standing):-
		...
		new_agent(data{donor_strategy: "Cooperator", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 0}, true),
		new_agent(data{donor_strategy: "Defector", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 1}, true),
		new_agent(data{donor_strategy: "Standing Discriminator", non_donor_strategy: "Spread Accurate Positive", trust_model: "Trusting", options: [], community: ID, generation: 0, player: 2}, true),
		assertion(add_new_action_interaction_percept(data{community: ID, generation: 0,
	...
	test(spread_accurate_negative_trusting_standing):-
		...
		new_agent(data{donor_strategy: "Cooperator", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 0}, true),
		new_agent(data{donor_strategy: "Defector", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 1}, true),
		new_agent(data{donor_strategy: "Standing Discriminator", non_donor_strategy: "Spread Accurate Negative", trust_model: "Trusting", options: [], community: ID, generation: 0, player: 2}, true),
		assertion(add_new_action_interaction_percept(data{community: ID, generation: 0,
	...
	test(lazy_trusting_standing):-
		new_community(ID),
		new_generation(data{community: ID, generation: 0}, true),
		new_agent(data{donor_strategy: "Standing Discriminator", non_donor_strategy: "Lazy", trust_model: "Trusting", options: [], community: ID, generation: 0, player: 0}, true),
	...
	test(promote_self_trusting_standing):-
		...
		new_agent(data{donor_strategy: "Cooperator", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 0}, true),
		new_agent(data{donor_strategy: "Defector", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 1}, true),
		new_agent(data{donor_strategy: "Standing Discriminator", non_donor_strategy: "Promote Self", trust_model: "Trusting", options: [], community: ID, generation: 0, player: 2}, true),
	...
	test(spread_accurate_positive_distrusting_standing):-
		...
		new_agent(data{donor_strategy: "Cooperator", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 0}, true),
		new_agent(data{donor_strategy: "Defector", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 1}, true),
		new_agent(data{donor_strategy: "Standing Discriminator", non_donor_strategy: "Spread Accurate Positive", trust_model: "Distrusting", options: [], community: ID, generation: 0, player: 2}, true),
		assertion(add_new_action_interaction_percept(data{community: ID, generation: 0,
			perceiver: 2, donor: 1, recipient: 0, timepoint: 17, action: "defect"}, true)),
		assertion(add_new_action_interaction_percept(data{community: ID, generation: 0,
			perceiver: 2, donor: 0, recipient: 1, timepoint: 29, action: "defect"}, true)),
	...
	test(spread_accurate_negative_distrusting_standing):-
		...
		new_agent(data{donor_strategy: "Cooperator", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 0}, true),
		new_agent(data{donor_strategy: "Defector", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 1}, true),
		new_agent(data{donor_strategy: "Standing Discriminator", non_donor_strategy: "Spread Accurate Negative", trust_model: "Distrusting", options: [], community: ID, generation: 0, player: 2}, true),
		assertion(add_new_action_interaction_percept(data{community: ID, generation: 0,
			perceiver: 2, donor: 1, recipient: 0, timepoint: 5, action: "defect"}, true)),
		check_correct_action_timepoints([6, 8, 11, 13, 14, 120], ID, 0, 2, action{type: gossip, value: negative, about: 1, recipient: _}),
		check_correct_action_timepoints([0, 1, 2, 4], ID, 0, 2, action{type: idle}).
	...
	test(lazy_distrusting_standing):-
		new_community(ID),
		new_generation(data{community: ID, generation: 0}, true),
		new_agent(data{donor_strategy: "Standing Discriminator", non_donor_strategy: "Lazy", trust_model: "Distrusting", options: [], community: ID, generation: 0, player: 0}, true),
		check_correct_action_timepoints([0, 1, 2, 7, 9, 10, 11, 120], ID, 0, 0, action{type: idle}).
	...
	test(promote_self_distrusting_standing):-
		...
		new_agent(data{donor_strategy: "Cooperator", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 0}, true),
		new_agent(data{donor_strategy: "Defector", non_donor_strategy: "Lazy", trust_model: "Void", options: [], community: ID, generation: 0, player: 1}, true),
		new_agent(data{donor_strategy: "Standing Discriminator", non_donor_strategy: "Promote Self", trust_model: "Distrusting", options: [], community: ID, generation: 0, player: 2}, true),

...
test(experiments_general, [setup(run(4))]):-
	assertion(holds_at(interaction_timepoints(agent(strategy("Standing Discriminator", _, ["trusting"]), community(0), generation(community(0), 0), 5),
	...
	assertion(holds_at(interaction_timepoints(agent(strategy("Standing Discriminator", _, ["trusting"]), community(0), generation(community(0), 0), 5),
		agent(strategy("defector", _, []), community(0), generation(community(0), 0), 6))=[1,4], 5)),
	assertion(\+holds_at(interaction_timepoints(agent(strategy("Standing Discriminator", _, ["trusting"]), community(0), generation(community(0), 0), 5),
		agent(strategy("cooperator", _, []), community(0), generation(community(0), 0), 7))=[1,4], 5)),
	assertion(\+holds_at(interaction_timepoints(agent(strategy("defector", _, []), community(0), generation(community(0), 0), 6),
		agent(strategy("cooperator", _, []), community(0), generation(community(0), 0), 7))=[], 1)),
	assertion(\+holds_at(interaction_timepoints(agent(strategy("defector", _, []), community(0), generation(community(0), 0), 6),
		agent(strategy("cooperator", _, []), community(0), generation(community(0), 0), 7))=[], 3)),
	assertion(holds_at(interaction_timepoints(agent(strategy("defector", _, []), community(0), generation(community(0), 0), 6),
		agent(strategy("cooperator", "desc", []), community(0), generation(community(0), 0), 7))=[3], 4)),
	assertion(holds_at(interaction_timepoints(agent(strategy("cooperator", _, []), community(0), generation(community(0), 0), 7),
		agent(strategy("defector", "desc", []), community(0), generation(community(0), 0), 6))=[5], 6)),
	assertion(\+holds_at(interaction_timepoints(agent(strategy("cooperator", _, []), community(0), generation(community(0), 0), 7),
		agent(strategy("defector", "desc", []), community(0), generation(community(0), 0), 6))=[5,6], 6)),
	assertion(holds_at(interaction_timepoints(agent(strategy("cooperator", _, []), community(0), generation(community(0), 0), 7),
		agent(strategy("Standing Discriminator", "desc", ["trusting"]), community(0), generation(community(0), 0), 5))=[6], 7)),
	assertion(\+holds_at(interaction_timepoints(agent(strategy("Standing Discriminator", _, ["trusting"]), community(0), generation(community(0), 0), 8),

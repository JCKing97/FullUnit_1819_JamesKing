...
class AgentsTest(unittest.TestCase):
    ...
    def test_agent_creation1(self):
        ...
        agent_response = requests.request("PUT", self.url + '/agent', json=agent_payload).json()
    ...
    def test_agent_creation2(self):
        ...
        agent_payload1 = {"strategy": "Defector", "options": [], "community": community_response['id'],
                         "generation": 0, "player": 0}
        agent_response1 = requests.request("PUT", self.url + '/agent', json=agent_payload1).json()
        ...
        agent_response2 = requests.request("PUT", self.url + '/agent', json=agent_payload2).json()
